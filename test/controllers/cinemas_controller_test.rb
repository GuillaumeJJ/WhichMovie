...
class CinemasControllerTest < ActionController::TestCase
  ...
  test "should create cinema" do
    assert_difference('Cinema.count') do
      post :create, cinema: { adresse: @cinema.adresse, seancehoraire: @cinema.seancehoraire, ville: @cinema.ville, nom:@cinema.nom, film_id:@cinema.film_id }
    end
  ...
  test "should update cinema" do
    patch :update, id: @cinema, cinema: { adresse: @cinema.adresse, seancehoraire: @cinema.seancehoraire, ville: @cinema.ville, nom:@cinema.nom, film_id:@cinema.film_id}
    assert_redirected_to cinema_path(assigns(:cinema))
  end
